...
import static com.example.android.sunshine.utilities.NetworkUtils.*;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void  loadWeatherData(){
        ...
        new GetWeatherFromServer().execute(url);
    }
    // TODO (5) Create a class that extends AsyncTask to perform network requests
    // TODO (6) Override the doInBackground method to perform your network requests
    // TODO (7) Override the onPostExecute method to display the results of the network request
    public class GetWeatherFromServer extends AsyncTask<URL, Void, String> {
        @Override
        protected void onPostExecute(String s) {
            super.onPostExecute(s);
            try {
             String[] strings =   OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,s);
