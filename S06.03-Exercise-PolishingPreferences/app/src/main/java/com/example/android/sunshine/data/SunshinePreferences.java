...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String prefDefaultWeather = context.getString(R.string.pref_location_default);
        return preferences.getString(prefLocationKey, prefDefaultWeather);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        String contextUnits = context.getString(R.string.pref_units_metric);
        String prefUnits = preferences.getString(prefUnitsKey, contextUnits);

        Boolean prefUser = true;
        if (!(contextUnits.equals(prefUnits))) {
            prefUser = false;
        }
        return prefUser;
    }
